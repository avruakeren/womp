...
import {
  Lock, Send, Settings, LogOut, Search, UserPlus, X,
  MessageSquare, Key, Database, ArrowLeft, Upload
} from 'lucide-react';
...
export default function Home() {
  ...
  if (!isAuthenticated) return null; // Avoid flicker during redirect
                    ...
                    >
                      ...
                      <div className="item-details">
                        ...
                        <div className="item-subtitle">
                          {lastMsg ? lastMsg.content : 'Obrolan aman'}
                        </div>
                      </div>
                    </div>
                  );
        ...
        {!activeFriendId ? (
          <div className="empty-chat-screen">
            ...
            <p className="empty-chat-desc">
              Pilih teman di sebelah kiri buat mulai obrolan aman.
            </p>
          </div>
        ) : (
          <>
            ...
            <div className="chat-input-area">
              <form onSubmit={handleSendMessageSubmit} className="chat-form">
                <div className="chat-input-wrapper">
                  <input
                    type="text"
                    placeholder={`Kirim pesan ke @${activeFriend?.username}...`}
          ...
          <div className="modal-card">
            ...
            <div className="profile-photo-editor">
              ...
              <div className="avatar-help-text">
                ...
                Foto akan dikompresi ke WebP sebelum diunggah.
              </div>
            </div>
